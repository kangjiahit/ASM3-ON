...
%%%%%%%%%%%%%输入反应器运行初始值%%%%%%%%%%%%
%%%%溶解氧(mg/L)%%%
S_O=[8.8 7.65 7.5 7.4 7.4];
%%基质浓度(mg/L)%%
S_S=[7.25 5.76 5.12 4.58 3.77];
%%%进水UAP浓度%%%%%
S_UAP=[0.65 1.09 1.52 2.02 2.72];
%%进水BAP浓度(mg/L)%%
S_BAP=[0.45 0.45 0.46 0.48 0.47];
%%%氨氮浓度%%%
S_NH=[8.18 7.71 7.15 6.54 6.00];
%%%亚硝氮硝氮浓度%%%
S_NO=[0.93 1.26 1.81 2.42 2.96];
%%%碱度%%%
